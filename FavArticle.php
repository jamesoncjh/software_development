...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-6 mb-4">Favorite Article</h1>
    ...
    <?php
        if(isset($_SESSION["userid"]) && isset($_SESSION['isLogin']) && $_SESSION["isLogin"]===true && isset($_SESSION['role']) && $_SESSION['role']=='user'){
            $user_id = $_SESSION['userid'];
            // $sql = "SELECT * FROM favorites JOIN diseases ON favorites.disease_id = diseases.disease_id WHERE favorites.user_id = " . $_SESSION['userid'];
            $sql = "SELECT d.*, f.* FROM diseases d JOIN favorites f ON f.disease_id = d.disease_id WHERE f.user_id = $user_id";
    ...
    <tbody>
        ...
        <tr class="text-center">
            ...
            <td class="col-2"><?php echo $row['addTime']; ?></td>
    ...
    <?php
            ...
            echo '<p class="text-center" style="font-size: 21px;">No favorite articles found.</p>';
        }
    }
    ?>
