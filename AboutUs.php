...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h5 class="d-inline-block text-primary text-uppercase border-bottom border-5">Our Consultant</h5>
            ...
            <div class="owl-carousel team-carousel position-relative">
                    ...
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Philip Wong Liang Jian</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Endocrinologists Specialist</h6>
                                <p class="m-0">Experts on hormones and metabolism. Can treat conditions like diabetes, thyroid problems, infertility, and calcium and bone disorders.</p>
                            </div>
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Jackson Ooi Ping Hua</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Cardiology Specialist</h6>
                                <p class="m-0">They’re experts on the heart and blood vessels. You might see them for heart failure, a heart attack, high blood pressure, or an irregular heartbeat.</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-facebook-f"></i></a>
                ...
                <div class="team-item">
                    <div class="row g-0 bg-light rounded overflow-hidden">
                        ...
                        <div class="col-12 col-sm-7 h-100 d-flex flex-column">
                            <div class="mt-auto p-4">
                                <h3>Cheng Jia Ying</h3>
                                <h6 class="fw-normal fst-italic text-primary mb-4">Dermatologists Specialist</h6>
                                <p class="m-0">Have problems with your skin, hair, nails? Do you have moles, scars, acne, or skin allergies? Dermatologists can help.</p>
                            </div>
                            <div class="d-flex mt-auto border-top p-4">
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-lg btn-primary btn-lg-square rounded-circle me-3" href="#"><i class="fab fa-facebook-f"></i></a>
