...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-6 mb-2">Edit Hospital Information</h1>
    ...
    <?php if(isset($_GET['HospitalId']) && isset($_GET['state'])) {
        $state = $_GET['state']; 
         ...
         $sql = "SELECT * FROM hospitals WHERE hospital_id = $hospitalId and deleted = FALSE";
    ...
    <div class="container-fluid pt-1 mb-5">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-center"><?php echo $row['hospital_name'] ?> Hospital Information</h5>
                        <form method="post">
                        <div class="mb-3">
                        ...
                        <input type="hidden" name="hospitalid" value="<?php echo $_GET['HospitalId']; ?>">
    ...
    <?php     
        if(isset($_POST['update'])){
            ...
            $sql = "SELECT * FROM hospitals WHERE hospital_name = '$hospitalName' AND hospital_id != '$hospital_id' AND deleted = FALSE";
            $result = $mysqli->query($sql);
            ...
            $sql = "SELECT * FROM hospitals WHERE hospital_address = '$hospitalAddress' AND hospital_id != '$hospital_id' AND deleted = FALSE";
            $result = $mysqli->query($sql);
            if (mysqli_num_rows($result) > 0) {
                // Email already exists
                echo ("<script LANGUAGE='JavaScript'>
            ...
            $sql = "SELECT * FROM hospitals WHERE hospital_lat = '$hospitalLat' AND hospital_lng = '$hospitalLng' AND hospital_id != '$hospital_id' AND deleted = FALSE";
            $result = $mysqli->query($sql);
            if (mysqli_num_rows($result) > 0) {
                // Email already exists
                echo ("<script LANGUAGE='JavaScript'>
