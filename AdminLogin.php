            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <?php } else { ?>
                        <a href="AdminLogin.php" class="nav-item nav-link active">Login</a>
                        <a href="AdminSignup.php" class="nav-item nav-link">Signup</a>
                        <?php } ?>
                    </div>
                </div>
            </nav>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            <div class="text-center mx-auto mb-5" style="max-width: 500px;">
                <h1 class="display-4 mb-4">Admin Login</h1>
        ...
        <div class="col-md-6 col-lg-5">
          <div class="card">
            ...
            <div class="card-footer">
              <p>Don't have an account? <a href="AdminSignup.php">Signup here</a></p>
            </div>
          </div>
        </div>
      </div>
